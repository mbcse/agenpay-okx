...
async function checkRequirements() {
  ...
  // Optional services
  console.log('\n🔧 Optional Services:');
  console.log(`💳 CDP Wallet: ${process.env.CDP_API_KEY_NAME ? '✅ Live' : '🧪 Mock'}`);
...
CDP_WALLET_DATA_FILE=./wallet_data.json
...
async function displayFinalInstructions() {
  ...
  console.log('   - CDP_API_KEY_NAME & CDP_PRIVATE_KEY (for live wallet)');
